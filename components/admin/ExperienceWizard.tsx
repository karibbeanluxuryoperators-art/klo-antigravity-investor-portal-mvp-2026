...
const T = {
  ...
  kloServiceFeeHint:{ EN: 'Champagne, red carpet, butler, seamless transitions between partners. This is KLO\'s only revenue source.',
                       ES: 'Champagne, tapete rojo, mayordomo, transiciones entre socios. Esta es la única fuente de ingresos KLO.',
                       PT: 'Champagne, tapete vermelho, mordomo, transições entre parceiros. Esta é a única fonte de receita KLO.' },
  kloMarkupPct:     { EN: 'KLO Markup % (on service fee)', ES: 'Markup KLO % (sobre tarifa)', PT: 'Markup KLO % (sobre taxa)' },
  kloMarkupHint:    { EN: 'Default 10%. Partners don\'t see this. 100% goes to KLO.',
                       ES: 'Default 10%. Los socios no lo ven. 100% va a KLO.',
                       PT: 'Default 10%. Os parceiros não veem. 100% vai para KLO.' },
  ...
  suppliersCost:    { EN: 'Partners (cost pass-through)',  ES: 'Socios (costo directo)',     PT: 'Parceiros (custo direto)'   },
