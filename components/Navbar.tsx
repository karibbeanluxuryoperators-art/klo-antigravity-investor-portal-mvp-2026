...
const Navbar: React.FC<NavbarProps> = ({ lang, setLang, t, onInquiryOpen }) => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-700 ${isScrolled ? 'bg-white/95 backdrop-blur-md shadow-lg py-3 border-b border-black/5' : 'bg-black/30 backdrop-blur-md py-4 border-b border-white/5'}`}>
      <div className="container mx-auto px-6 flex items-center justify-between">
        <div className="flex items-center space-x-12">
          <a href="/" className="flex items-center transition-all duration-500 hover:opacity-80">
            <img 
              src="/klo-logo.png" 
              alt="KLO" 
