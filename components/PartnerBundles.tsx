  ...
  const tMap = {
    EN: {
      ...
      modal: {
        ...
        pickAssets: 'Choose assets from approved partners',
        pickHint: 'Select assets, then set quantity for each.',
        none: 'No available assets found. At least one partner must be APPROVED with ACTIVE assets.',
        qty: 'Qty',
        from: 'from',
        total: 'Live total',
    ...
    ES: {
      eyebrow: 'Paquetes Multi-Socio',
      title: 'Tus Paquetes',
      sub: 'Combina servicios de socios KLO aprobados en un solo paquete reservable.',
      create: 'Crear Paquete',
      new: 'Nuevo Paquete',
      empty: 'Aún no tienes paquetes. Crea el primero combinando servicios de socios aprobados.',
      ...
      modal: {
        ...
        pickAssets: 'Elige activos de socios aprobados',
        pickHint: 'Selecciona activos y luego define la cantidad.',
        none: 'No hay activos disponibles. Al menos un socio debe estar APROBADO con activos ACTIVOS.',
        qty: 'Cant.',
        from: 'de',
        total: 'Total en vivo',
    ...
    PT: {
      eyebrow: 'Pacotes Multi-Parceiro',
      title: 'Seus Pacotes',
      sub: 'Combine serviços de parceiros KLO aprovados em um único pacote reservável.',
      create: 'Criar Pacote',
      new: 'Novo Pacote',
      empty: 'Sem pacotes ainda. Crie o primeiro combinando serviços de parceiros aprovados.',
      ...
      modal: {
        ...
        pickAssets: 'Escolha ativos de parceiros aprovados',
        pickHint: 'Selecione os ativos e defina a quantidade.',
        none: 'Nenhum ativo disponível. Pelo menos um parceiro deve estar APROVADO com ativos ATIVOS.',
        qty: 'Qtd.',
        from: 'de',
        total: 'Total ao vivo',
        submit: 'Criar Pacote',
