...
export const TRANSLATIONS = {
  es: {
    ...
    services_cta: {
      subtitle: "Comience una conversación",
      button: "Contactar al equipo"
    },
    concierge: {
      title: "Su viaje, a una conversación de distancia",
      desc: "Hable con María, su asesora personal, haciendo clic en el botón dorado abajo a la derecha. Atendemos de lunes a sábado, 8am a 8pm hora Colombia.",
      or_email: "O escríbanos directamente a"
    },
    services: {
      ...
      flights: {
        ...
        desc: "Charter a medida en jets ligeros, midsize y de largo alcance. Disponibilidad instantánea de aeronaves en rutas domésticas e internacionales. Integración con operadores líderes del sector (próximamente)."
      },
      accommodation: {
        title: "Alojamientos (Smart API)",
        desc: "Villas privadas, hoteles cinco estrellas y eco-lodges en los destinos más exclusivos de Colombia y el Caribe. Reservas a medida con un equipo dedicado (próximamente)."
      },
      yachts: {
        title: "Yates y Veleros (Direct API)",
        desc: "Yates a motor, veleros, catamaranes y superyates en Cartagena, San Andrés y el Caribe colombiano. Días, fines de semana o temporadas completas (próximamente)."
      },
      transport: {
        title: "Transporte Terrestre",
        desc: "Traslados en vehículos ejecutivos y blindados, con chófer profesional disponible por horas, días o temporadas."
      },
      staff: {
  ...
  en: {
    ...
    concierge: {
      title: "Your journey, one conversation away",
      desc: "Speak with María, your personal concierge, by clicking the gold button at the bottom right. Available Monday through Saturday, 8am to 8pm Colombia time.",
      or_email: "Or write to us directly at"
    },
    services: {
      ...
      flights: {
        ...
        desc: "Bespoke charter on light, midsize, and long-range jets. Instant availability across domestic and international routes. Integration with leading operators (coming soon)."
      },
      accommodation: {
        title: "Accommodations (Smart API)",
        desc: "Private villas, five-star hotels, and ultra-luxury eco-lodges across the most exclusive destinations in Colombia and the Caribbean. Bespoke reservations with a dedicated team (coming soon)."
      },
      yachts: {
        title: "Yachts & Sailboats (Direct API)",
        desc: "Motor yachts, sailboats, catamarans, and superyachts in Cartagena, San Andrés, and the Colombian Caribbean. Days, weekends, or full seasons (coming soon)."
      },
      transport: {
        title: "Ground Transportation",
        desc: "Transfers in executive and armored vehicles, with a professional chauffeur available by the hour, day, or full season."
      },
      staff: {
  ...
  pt: {
    ...
    services_cta: {
      subtitle: "Inicie uma conversa",
      button: "Falar com a equipe"
    },
    concierge: {
      title: "Sua jornada, a uma conversa de distância",
      desc: "Fale com María, sua concierge pessoal, clicando no botão dourado no canto inferior direito. Disponível de segunda a sábado, das 8h às 20h horário da Colômbia.",
      or_email: "Ou escreva diretamente para"
    },
    services: {
      ...
      flights: {
        ...
        desc: "Charter sob medida em jatos leves, midsize e de longo alcance. Disponibilidade instantânea em rotas domésticas e internacionais. Integração com operadores líderes do setor (em breve)."
      },
      accommodation: {
        title: "Acomodações (Smart API)",
        desc: "Vilas privadas, hotéis cinco estrelas e eco-lodges nos destinos mais exclusivos da Colômbia e do Caribe. Reservas sob medida com equipe dedicada (em breve)."
      },
      yachts: {
        title: "Iates e Veleiros (Direct API)",
        desc: "Iates a motor, veleiros, catamarãs e superiates em Cartagena, San Andrés e Caribe colombiano. Dias, finais de semana ou temporadas completas (em breve)."
      },
      transport: {
        title: "Transporte Terrestre",
        desc: "Traslados em veículos executivos e blindados, com motorista profissional disponível por horas, dias ou temporadas."
      },
      staff: {
